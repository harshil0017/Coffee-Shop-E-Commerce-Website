...
<body>
   ...
   require_once("Database/functions.php");
    ...
    $database = new createDb($_GET['dbname'] = "Productdb", $_GET['tablename'] = "Mug");
    ...
    if(isset($_POST['add'])){ //if click on the add button
     ...
     if(isset($_SESSION['cart']))
     {
        ...
        if(in_array($_POST['product_id'], $item_array_id)){  //if this product id is already in this array
            ...
            echo "<script>window.location = 'mug.php'</script>";    //coffee page is then reopen
          } else{
   ...
   ?>
    ...
    <section class="product">
       ...
       <h1 class="heading-product">Cup & Mug</h1>

...
<body>
   ...
   $database = new createDb($_GET['dbname'] = "Productdb", $_GET['tablename'] = "Chocolate");
   ...
   if (isset($_POST['add'])){  //if click on the add button
      ...
      if (isset($_SESSION['cart'])) {
         ...
         if (in_array($_POST['product_id'], $item_array_id)) {  //if this product id is already in this array
            ...
            echo "<script>window.location = 'choco.php'</script>";    //coffee page is then reopen
         } else {
      ...
      $result = $database->getData();
               ...
               $root = $dom->createElement('Products'); // Already created else if not comment it will overwrite
   ...
   <section class="product">
      ...
      <h1 class="heading-product">Chocolate</h1>
